...
$c_detail = new c_news();
$data=$c_detail->detail();
$detail = $data['data'];
$dataInvol=$c_detail->getInvolve($detail['id_loaitin']);
$involve =$dataInvol['list']; 
$dataMenu = $c_detail->Menu();
$menu = $dataMenu['data'];

$dataLink = $c_detail->linkNew();
$link=$dataLink['data'];

$dataUpBy=$c_detail->upBy();
$upBy=$dataUpBy['data'];
// print_r($upBy);
...
<div class = "container-fluid">
    ...
    <div class="container">
        <div class="row">
             <div class="col-md-9">
                <h3><?=$detail['tieude'];?></h3>
                <p class="timeup">Post on: <?php $date=date_create($detail['timeup']); echo date_format($date,"H:i:sa d/m/Y"); ?> by  <b class="upby"><?=$upBy['name'];?></b></p>
                <div class="linkNew"><span><a href ="http://localhost/demo_oop_mvc/trang-chu">Trang chủ</a></span>&nbsp;>>&nbsp;<span><a href="list.php?theloai=<?=$link['id']?>"><?=$link['name']?></a></span>&nbsp;>>&nbsp;<span><a href="list2.php?loaitin=<?=$link['c_id']?>"><?=$link['c_name']?></a></span></div>
                <h4 class="tomtat"><?=$detail['tomtat'];?></h4>
                <div class="wrap-img">
                    <img class="img-new" src="<?=$detail['hinh'];?>"></div>
                <p class="mota-anh"><?=$detail['mota'];?></p>
                <div class="wrap-content">
                    <p class="txt-content-new"><?=$detail['noidung'];?></p>
                </div>
             </div>
             <div class="col-md-3">
                 <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                         <?php 
                            foreach($involve as $value){
                                if($value['id']!=$detail['id']){
                                ?>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-md-5">
                                            <a class="involNew" href="chitiet.php?id=<?=$value['id'];?>">
                                                <img class="img-responsive" src="<?=$value['hinh']?>" alt="ảnh">
                                            </a>
                                        </div>
                                        <div class="col-md-7 title-invol">
                                            <a class="involNew" href="chitiet.php?id=<?=$value['id'];?>"><b><?=$value['tieude']?></b></a>
                                        </div></div>
                                        <div class="break"></div>
