...
$c_list = new c_news();
$dataList = $c_list->getList();
$listNew = $dataList['list'];
// $title = $c_list->getTitle();
// print_r($listNew);
// die($title);
...
<body>
        <div class = "container-fluid">
                <div class = "row">
                    <div id = "header">
                        <a href ="#"><img src="../public/img/logo-footer.png"></a>
                                        ...
                                        <ul class="dropdown-menu">
                                            <?php 
                                                ...
                                                foreach($c_categories as $cc_value){
                                                    ...
                                                    ?>
                                                    <li><a href="<?php echo "danh-sach-".$c_id."html";?>"><?=$c_name?></a></li>
                                                    <?php 
                                                }
                                            ?>                                           
                            ...
                            foreach($listNew as $value){
                                ?>
                                    <div class="item-new">
                                        ...
                                        <div class="col-md-9">
                                        <a style="color:#333;" href="chitiet.php?id=<?=$value['id']?>"><h3><?=$value['tieude']?></h3></a>
                                                <p><?=$value['tomtat']?></p>
                                                <a class="btn btn-primary" href="chitiet.php?id=<?=$value['id']?>">Chi tiết <span class="glyphicon glyphicon-chevron-right"></span></a>
                                        </div>
                                    </div>
        ...
        <div class = "container">
            <div class="top-footer">
                <div class="col-md-3">
                    <a href ="#"><img id="logo-footer" src ="../public/img/logo-footer.png"></a>
                </div>
                <div class="col-md-9">
